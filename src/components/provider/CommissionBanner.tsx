...
export default function CommissionBanner() {
  ...
  return (
    <>
      <div className={`rounded-[24px] p-4 mb-6 flex items-center justify-between gap-4 ${
        isBlocked
        ...
        <div className="flex items-center gap-3">
          {isBlocked ? (
            <div className="h-10 w-10 rounded-[16px] bg-red-100 dark:bg-red-900/50 flex items-center justify-center shrink-0">
              <Ban className="h-5 w-5 text-red-600" />
            </div>
          ) : (
            <div className="h-10 w-10 rounded-[16px] bg-amber-100 dark:bg-amber-900/50 flex items-center justify-center shrink-0">
        ...
        <button
          ...
          className="shrink-0 px-4 py-2 rounded-[16px] bg-gradient-to-r from-orange-500 to-orange-600 text-primary-foreground text-sm font-semibold hover:from-orange-600 hover:to-orange-700 transition-all shadow-lg shadow-orange-500/20"
        >
