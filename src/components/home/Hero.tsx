...
export const Hero = () => {
  ...
  return (
    <div className="relative w-full min-h-[500px] md:min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden bg-slate-50">
      ...
      <div className="absolute inset-0 z-10 bg-white/90 md:bg-transparent md:bg-gradient-to-r md:from-white/95 md:via-white/80 md:via-40% md:to-transparent md:to-60%" />
